...
type BlogPageDocumentDataSlicesSlice = CallToActionSlice | AlternateGridSlice | CustomerLogosSlice | HeroSlice

type BlogPageDocumentDataSlices1Slice = never
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AlternateGridSliceDefault = prismic.SharedSliceVariation<"default", Simplify<AlternateGridSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AlternateGridSliceImageRight = prismic.SharedSliceVariation<"imageRight", Simplify<AlternateGridSliceImageRightPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceAlignLeft = prismic.SharedSliceVariation<"alignLeft", Simplify<CallToActionSliceAlignLeftPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CustomerLogosSliceDefault = prismic.SharedSliceVariation<"default", Simplify<CustomerLogosSliceDefaultPrimary>, never>;
...
/**
 * Primary content in *HeroSectionWithImage → Default → Primary*
 */
export interface HeroSectionWithImageSliceDefaultPrimary {
	/**
	 * Post Image field in *HeroSectionWithImage → Default → Primary*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: hero_section_with_image.default.primary.post_image
	 * - **Documentation**: https://prismic.io/docs/fields/image
	 */
	post_image: prismic.ImageField<never>;
	
	/**
	 * Post Heading field in *HeroSectionWithImage → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: Main Blog Post Heading
	 * - **API ID Path**: hero_section_with_image.default.primary.post_heading
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
	post_heading: prismic.RichTextField;
	
	/**
	 * Author Name field in *HeroSectionWithImage → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: The publisher of the Blog Post
	 * - **API ID Path**: hero_section_with_image.default.primary.author_name
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
...
/**
 * Default variation for HeroSectionWithImage Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroSectionWithImageSliceDefault = prismic.SharedSliceVariation<"default", Simplify<HeroSectionWithImageSliceDefaultPrimary>, never>;

/**
 * Slice variation for *HeroSectionWithImage*
 */
type HeroSectionWithImageSliceVariation = HeroSectionWithImageSliceDefault

/**
 * HeroSectionWithImage Shared Slice
 *
 * - **API ID**: `hero_section_with_image`
 * - **Description**: HeroSectionWithImage
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroSectionWithImageSlice = prismic.SharedSlice<"hero_section_with_image", HeroSectionWithImageSliceVariation>;
...
export interface RichTextSliceDefaultPrimary {
	/**
	 * Paragraph Text field in *RichText → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: Add your paragraph here ...
	 * - **API ID Path**: rich_text.default.primary.paragraph_text
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
...
declare module "@prismicio/client" {
	...
	namespace Content {
		export type {
			...
			HeroSliceDefault,
			HeroSliceImageRight,
			HeroSectionWithImageSlice,
			HeroSectionWithImageSliceDefaultPrimary,
			HeroSectionWithImageSliceVariation,
			HeroSectionWithImageSliceDefault,
			RichTextSlice,
