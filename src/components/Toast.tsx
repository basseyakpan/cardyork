...
export default function Toast() {
  ...
  return (
    <div
      className={`fixed bottom-8 right-8 z-[200] glass-card px-6 py-4 flex items-center gap-4 animate-fade-in-up border-l-4 ${typeStyles[toast.type as keyof typeof typeStyles]}`}
    >
