  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="glass-card p-8 flex flex-col items-center gap-4 text-center mx-auto w-full max-w-2xl mt-12">
        ...
        <h2 className="text-3xl font-extrabold text-on-surface">Help & Support</h2>
        <p className="text-on-surface-variant">Get in touch with our 24/7 customer support team or read our FAQ. This page is currently under construction.</p>
