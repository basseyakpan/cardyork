  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="glass-card p-8 flex flex-col items-center gap-4 text-center mx-auto w-full max-w-2xl mt-12">
        <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-3xl mb-2">🛡️</div>
        <h2 className="text-3xl font-extrabold text-on-surface">Security Settings</h2>
        <p className="text-on-surface-variant">Manage your password, 2FA, and review your account login history. This page is currently under construction.</p>
