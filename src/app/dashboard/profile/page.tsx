...
export default function ProfilePage() {
  ...
  const { bankAccounts, isLoading: isWalletLoading } = useAppSelector(
    (s) => s.wallet,
  );
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto pb-10">
      ...
      <div className="flex flex-col gap-2">
        <h3 className="text-xs font-bold text-primary tracking-widest uppercase ml-1">
          Bank Details
        </h3>
            ...
            <>
              {bankAccounts.map((account, index) => (
                <div
                  ...
                  className="flex items-center justify-between p-4 bg-surface-container rounded-xl border border-outline-variant"
                >
