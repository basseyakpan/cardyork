  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="glass-card p-8 flex flex-col items-center gap-4 text-center mx-auto w-full max-w-2xl mt-12">
        ...
        <p className="text-on-surface-variant">Update your personal details, email preferences, and notification settings. This page is currently under construction.</p>
