...
export default function Login() {
        ...
        dispatch(
          showToast({
            message:
              typeof error === "string"
                ? error
                : error?.message || "Login details incorrect, try again",
            type: "error",
          }),
        );
      }
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      dispatch(
        showToast({ message: err?.message || "Resend failed", type: "error" }),
      );
    }
  };
            ...
            {!showOtp ? (
              ...
              >
                ...
                <button
                  ...
                  className="text-sm text-on-surface-variant hover:text-on-surface flex items-center gap-1 mx-auto mt-4 font-medium"
                >
      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center bg-surface-container-high border-l border-primary/10">
        ...
        <div className="relative z-10 max-w-lg p-12 text-center">
          ...
          <p className="text-on-surface-variant text-lg leading-relaxed">
            Access the highest market rates for your digital assets. Instant
            verification, zero delays.
          </p>
        </div>
      </div>
    </div>
